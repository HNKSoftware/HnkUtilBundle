...
class FormRender
{
    ...
    public function getFormTemplate(FormInterface $form, TemplateInterface $template, $variableName = 'form')
    {
        $html = '';
    ...
    protected function renderFormRow(FormInterface $form, TemplateInterface $template, $variableName)
    {
        $html = '';
